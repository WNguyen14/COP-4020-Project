...
//			System.in.read();
	...
	void lectureExample3() throws Exception {
		String input = """
				image a(string url, int width, int height)
				      ...
				      ^b;
				      """;
		String url = "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7f/BenHillGriffinStadium.png/1920px-BenHillGriffinStadium.png";
	...
	void lectureExample6() throws Exception {
		String input = """
				...
				""";
		String url = "https://upload.wikimedia.org/wikipedia/commons/thumb/1/17/Theswamp.jpg/1280px-Theswamp.jpg";
