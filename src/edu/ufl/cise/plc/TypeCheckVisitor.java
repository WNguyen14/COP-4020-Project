...
public class TypeCheckVisitor implements ASTVisitor {
	...
	public Object visitColorConstExpr(ColorConstExpr colorConstExpr, Object arg) throws Exception {
		throw new TypeCheckException("color const");
	}
...
//		throw new TypeCheckException("bad conditional");
	...
	public Object visitAssignmentStatement(AssignmentStatement assignmentStatement, Object arg) throws Exception {
		Type sourceType = (Type) assignmentStatement.getExpr().getType();
		...
		if (targetType != Type.IMAGE) {
			check(assignmentCompatible(sourceType, targetType, "notImage"), assignmentStatement, "not image");
		}
	...
	public Object visitReadStatement(ReadStatement readStatement, Object arg) throws Exception {
		  ...
		  if (sourceType==Type.CONSOLE) {
			  readStatement.getSource().setCoerceTo(Type.INT);
		  }
